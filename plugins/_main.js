...
smd({
  ...
  try {
    ...
    return await _0x21be87.bot.sendMessage(_0x21be87.chat, {
      image: {
        url: await aiResponce(_0x21be87, "dall-e", _0x17d498)
      },
      caption: "*---Your DALL-E Result---*\n" + Config.caption
    });
  } catch (_0x25b4b9) {
    await _0x21be87.error(_0x25b4b9 + "\n\ncommand: dall-e", _0x25b4b9, "*_Sorry your message no answers from the Mrsky  Dall-E Ai, Sorry!!_*");
  }
});
smd({
  pattern: "imagine",
...
smd({
  ...
  try {
    ...
    let _0x5d0b6a = false;
    try {
      const _0x37057d = await fetch("https://aemt.me/openai?text=" + (_0x5e79d4 + " \nNOTE: Make sure to looks like imagination, make it short and concise, also in english and kiswahili!"));
...
smd({
  ...
  try {
    ...
    if (_0x5ea4b8.includes("rmore")) {
      await _0x5db0de.reply(_0x5ea4b8.replace(/rmore/, String.fromCharCode(8206).repeat(4001)));
    } else {
      await _0x5db0de.reply(_0x5ea4b8.replace(" ", String.fromCharCode(8206).repeat(4001)));
    }
  } catch (_0x36cb2c) {
    await _0x5db0de.error(_0x36cb2c + "\n\ncommand : rmore", _0x36cb2c, false);
  }
});
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("MRSKY-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("MRSKY-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
