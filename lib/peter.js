      ...
      for (mek of _0x1071af.messages) {
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            } else if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|mrsky/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
  ...
  _0x5447f8.ev.on("group-participants.update", async _0x33a505 => {
    try {
      ...
      events.commands.map(async _0x497293 => {
        ...
        if (/on|true|main|all|mrsky|smd/gi.test(_0x497293.group)) {
          try {
            _0x497293.function(_0x1684d7, {
              store: store,
              Void: _0x5447f8
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.mrsky/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
...
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".smd", ".mrsky"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
<title>Bouncing Text - King-pe</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
<div class="bounce-text">King-pe</div>
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^wasi_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/Mrsky;;;/gi, "").replace(/Astro;;;/gi, "").replace(/King-pe;;;/gi, "").trim();
